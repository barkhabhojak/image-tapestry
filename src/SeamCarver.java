...
public class SeamCarver {
	...
	public SeamCarver (String imageFilePath, String outputImageFilePath, int numCol, int numRow) {
	 ...
	 */
	private double[][] computeEnergy(BufferedImage image) {
	...
	private int[][] findVerticalSeam(double[][] energyTable) {
		int[][] seam;
	...
	private int[][] findHorizontalSeam(double[][] energyTable) {
		int[][] seam;
		int width = energyTable.length;
		int height = energyTable[0].length;
		// seamDynamic is the table we will use for dynamic programming.
